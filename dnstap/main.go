...
var (
	...
	flagAppendFile = flag.Bool("a", false, "append to the given file, do not overwrite. valid only when outputting a text file.")
...
func outputOpener(fname string, text, yaml bool, json bool, append bool) func() dnstap.Output {
